...
syms Id1 Iq1 Id2 Iq2 Id3 Iq3 Vd Vq Vd_cap Vq_cap Id_c Iq_c Vd_c Vq_c X1_pll Theta_pll ...
     ...
     Vdc Cdc Pn Vdcn Vdcref Vref Phi_filt Vdc_filt T1 T2

%% Vettore stato, algebraico e ingresso
x = [Id1; Iq1; Id2; Iq2; Vd_cap; Vq_cap; Phi_pc_p; Phi_pc_q; Phi_cc_d; Phi_cc_q; X1_pll; Theta_pll; Vdc; Phi_filt]; 
y = [Id3; Iq3; Vd; Vq; Id_c; Iq_c; Vd_c; Vq_c; Freq_pll; Id_star; Iq_star; Ud_c; Uq_c; Ud_s; Uq_s; Vdc_filt];
params = [R1; L1; R2; L2; R3; C3; WN; Kp_pc; Ki_pc; Kp_cc; Ki_cc; Kp_pll; Ki_pll; Ed; Eq; Pref; Vref; Vdcref; Cdc; Vdcn; Pn; T1; T2];  
...
f7 = Vdc_filt - Vdcref; 
f8 = sqrt(Vq_c^2 + Vd_c^2) - Vref;
f9 = Id_star - Id_c;
f10 = Iq_star - Iq_c;
f11 = Vq_c;
f12 = Freq_pll;
f13 = ((Pref - Vd_c*Id_c+Vq_c*Iq_c)/(Cdc * Vdc)) *(Pn/Vdcn^2); 
f14 = -(1/T2)*Phi_filt + Vdc;
...
g6 = Kp_pc * (Vdc_filt - Vdcref) + Ki_pc * Phi_pc_p - Id_star; 
g7 = Kp_pc * (sqrt(Vq_c^2 + Vd_c^2) - Vref) + Ki_pc * Phi_pc_q - Iq_star;
...
g16 = (1/T2 + T1/T2^2)*Phi_filt + T1/T2 * Vdc - Vdc_filt;
...
x_eq = [id1; iq1; id2; iq2; vd_cap; vq_cap; phi_pc_p; phi_pc_q; phi_cc_d; phi_cc_q; x1_pll; theta_pll; vdc; phi_filt];

y_eq = [id3; iq3; vd; vq; id_c; iq_c; vd_c; vq_c; freq_pll; id_star; iq_star; ud_c; uq_c; ud_s; uq_s; vdc_filt];

params_eq = [r1; l1; r2; l2; r3; c3; wN; kp_pc; ki_pc; kp_cc; ki_cc; kp_pll; ki_pll; ed; eq; pref; vref; vdcref; cdc; vdcn; pn; t1; t2];
...
ss_full.StateName = {'id1', 'iq1', 'id2', 'iq2', 'vd_cap', 'vq_cap', 'phi_pc_p', 'phi_pc_q', 'phi_cc_d', 'phi_cc_q', 'x1_pll', 'theta_pll', 'Vdc', 'phi_filt'}; %% aggiunto
%%
