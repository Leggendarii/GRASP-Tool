...
kp_inner_d_pu = parameter.Value(15);
ki_inner_d_pu = 1/parameter.Value(16);
kp_inner_q_pu = parameter.Value(15);
ki_inner_q_pu = 1/parameter.Value(16);
...
disp("---")
disp("White Box responce extracted and saved")
disp("---")